...
function Men() {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const response = await fetch("http://localhost:3005/productos/men"); // Cambia esta URL por tu endpoint
    ...
    <div className="men">
      ...
      <header className="header">
        <div className="header-title">
          <h1>Catálogo de Ropa para Hombre ({products.length})</h1>
          <p>Explora nuestra colección de ropa masculina</p>
        </div>
      </header>
