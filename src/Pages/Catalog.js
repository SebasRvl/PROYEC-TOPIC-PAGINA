...
function Catalog() {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const response = await fetch("http://localhost:3005/productos/todos"); // Cambia esta URL por tu endpoint
    ...
    <div className="catalog">
      ...
      <header className="header">
        <div className="header-title">
          <h1>Catálogo de Productos ({products.length})</h1>
          <p>Explora lo mejor en moda y estilo</p>
        </div>
      </header>
