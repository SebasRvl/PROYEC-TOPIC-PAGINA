...
function Women() {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const response = await fetch("http://localhost:3005/productos/woman"); // Cambia esta URL por tu endpoint
    ...
    <div className="women">
      ...
      <header className="header">
        <div className="header-title">
          <h1>Catálogo de Ropa para Mujer ({products.length})</h1>
          <p>Explora nuestra colección de ropa femenina</p>
        </div>
      </header>
